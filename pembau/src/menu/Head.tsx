...
export const Head = ({ }: HeadProps) => {
  ...
  const currentPageString = route.pathname === "/Pembau/" ? "_HOME" : route.pathname === "/Pembau/About/" ? "_ABOUT" : "";
    ...
    <div className="headmenu" >
      ...
      <div style={{ display: "flex", flexDirection: "row", width: "100%", height: "100%", justifyContent: "space-between", alignItems: "center" }}>
        ...
        >
          ...
          <svg className="icon" style={{ flex: "none", height: "100%", width: "auto" }} onClick={() => navigate("/")} viewBox="0 0 97 87" fill="none" xmlns="http://www.w3.org/2000/svg">
