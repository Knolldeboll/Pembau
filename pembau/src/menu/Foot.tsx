        ...
        <div className="footcontainer">
            <div className="footmenu" >
                <div className="footlogodiv">
                    ...
                    <p className="foot-logo-text" >PLATTFORM FÜR KUNST, <br></br> KULTUR UND <br></br> GESELLSCHAFT.</p>
                </div>
 ...
 */}
                <div className="socialmedia">
                    ...
                    <svg className="icon socialmediaicon" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="icon socialmediaicon" viewBox="0 0 45 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className="icon socialmediaicon" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div id="links" style={{ width: "27%", height: "100%" }}>
                    ...
                    <div style={{ display: "grid", width: "fit-content", gridTemplateColumns: "8vw 8vw ", gridTemplateRows: "1vw 1vw 1vw", gap: "1.5vw", marginLeft: "10%", marginTop: "1%" }}>
