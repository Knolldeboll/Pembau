        ...
        <div style={{ display: "flex", flexDirection: "row", width: "100vw", height: "10vw", backgroundColor: "black", fill: "white" }}>
            ...
            <div id="socialmedia" style={{ display: "flex", flexDirection: "row", scale: "0.7", gap: "2.5vw", width: "20%", height: "auto", marginLeft: "1%", transform: "translateY(1vw)" }}>
                ...
                <svg viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M16.9656 9.58242C30.4545 7.2842 32.5238 26.4662 21.0328 28.4259C7.54386 30.7241 5.47451 11.5421 16.9656 9.58242ZM17.4424 12.4337C9.88022 13.9691 11.201 26.4471 19.6548 25.6556C28.7141 24.8069 26.7354 10.5456 17.4424 12.4337Z" fill="white" />
                    <path d="M29.0528 8.94282C27.8751 7.78895 29.6154 5.74344 31.0077 6.8544C32.4811 8.03212 30.488 10.3494 29.0528 8.94282Z" fill="white" />
                </svg>

                <svg viewBox="0 0 45 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M42.3331 2.22263C45.4742 5.36369 45.2199 23.5003 43.4349 27.5895C42.1371 30.561 38.2545 30.9901 35.3889 31.1966C29.7106 31.6045 8.85675 31.9329 4.38617 30.3756C3.44862 30.0472 2.38394 29.5599 1.79599 28.7283C-0.645881 25.2959 -0.338661 8.45707 1.17625 4.39435C2.20914 1.61878 3.86178 0.776576 6.76447 0.448168C13.9153 -0.351663 22.8829 0.0879841 30.0496 0.46936C33.4661 0.649455 39.7376 -0.383446 42.3384 2.21733L42.3331 2.22263ZM16.5584 7.86912V22.7004L30.3357 15.5443L24.864 12.0166L16.5637 7.86912H16.5584Z" fill="white" />
                </svg>

                <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.4218 12.3134H19.8696L20.1434 15.0031L24.1269 12.5443C27.1978 12.0718 31.4283 11.8947 33.855 14.1656C34.4831 14.7562 35.9756 17.317 35.9756 17.9505V35.9356H28.9963V21.1717C28.9963 21.0268 27.7937 18.8578 27.5629 18.7129C25.3939 17.3224 20.4065 18.6216 20.4065 21.1717V35.9356H13.4272V12.3134H13.4218Z" fill="white" />
                    <path d="M8.58987 12.3135H0V35.9356H8.58987V12.3135Z" fill="white" />
                    <path d="M1.22419 1.18915C4.85341 -2.44007 10.9039 3.0306 7.29077 6.98731C3.49513 11.1373 -2.56072 4.97943 1.22419 1.18915Z" fill="white" />
                </svg>
